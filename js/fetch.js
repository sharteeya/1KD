...
const getAnalysisData = (tid, uid) => {

    fetch(`https://${window.location.host == '1know.net' ? '' : 'www.'}1know.net/private/group/task/${tid}/analytics/unit/${uid}`)
        .then((response) => {
...
const getMember = () => {
    fetch(`https://${window.location.host == '1know.net' ? '' : 'www.'}1know.net/private/group/${GROUP_ID}/member`)
        .then((response) => {
            return response.json();
        })
        .then((data) => {
...
const getTasks = () => {
    fetch(`https://${window.location.host == '1know.net' ? '' : 'www.'}1know.net/private/group/${GROUP_ID}/task`)
        .then((response) => {
            return response.json();
        })
        .then((data) => {
...
const getGroup = () => {
    fetch(`https://${window.location.host == '1know.net' ? '' : 'www.'}1know.net/private/group/${GROUP_ID}/member/team`)
        .then((response) => {
            return response.json();
        })
        .then((data) => {
